...
from efficient_track_anything.modeling.efficienttam_base import NO_OBJ_SCORE
...
class TAMCameraPredictor(EfficientTAMBase):
...
class TAMCameraPredictorVOS(TAMCameraPredictor):
